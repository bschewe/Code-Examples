...
int main() {
    ...
    system("PAUSE");
    /*
    solve_three_in_a_row(board, size, 0);
    solve_three_in_a_row(board, size, 1);
    solve_three_in_a_row(board, size, 2);
    solve_three_in_a_row(board, size, 3);
    solve_three_in_a_row(board, size, 4);
    solve_three_in_a_row(board, size, 5);
    solve_three_in_a_row(board, size, 6);
    solve_three_in_a_row(board, size, 7);
    solve_three_in_a_row(board, size, 8);
    solve_three_in_a_row(board, size, 9);
    solve_three_in_a_row(board, size, 10);
    */
    solve_three_in_a_column(board, size, 0);
    solve_three_in_a_column(board, size, 1);
    solve_three_in_a_column(board, size, 2);
    solve_three_in_a_column(board, size, 3);
    solve_three_in_a_column(board, size, 4);
    solve_three_in_a_column(board, size, 5);
    solve_three_in_a_column(board, size, 6);
